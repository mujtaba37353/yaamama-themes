...
<main class="y-l-auth-page" data-y="login-page">
    <div class="y-c-auth-card" data-y="login-card">
        ...
        <form method="post" data-y="login-form" id="login-form" class="woocommerce-form woocommerce-form-login login">
            ...
            <div class="y-l-forgot-password" data-y="forgot-password-link-container">
                <a href="<?php echo esc_url(wp_lostpassword_url()); ?>" class="y-c-forgot-password-link" data-y="forgot-password-link">هل نسيت كلمة المرور؟</a>
            </div>
