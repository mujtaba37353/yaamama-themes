...
let filterBarPath = window.darkThemeAssetUrl("components/products/y-c-filter-bar.html");

if (category === "shoes") {
  filterBarPath = window.darkThemeAssetUrl("components/products/y-c-shoes-filter-bar.html");
} else if (category === "bags") {
  filterBarPath = window.darkThemeAssetUrl("components/products/y-c-bags-filter-bar.html");
}
