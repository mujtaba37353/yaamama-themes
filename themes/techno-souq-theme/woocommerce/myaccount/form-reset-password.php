...
<div class="y-l-auth-container" data-y="auth-container">
    <div class="y-c-auth-column y-c-auth-column--single" data-y="reset-password-column">
        <h2 class="y-c-auth-title" data-y="reset-password-title"><?php esc_html_e('إنشاء كلمة مرور جديدة', 'techno-souq-theme'); ?></h2>

        <p class="y-c-auth-info" data-y="reset-password-info">
            <?php echo apply_filters('woocommerce_reset_password_message', esc_html__('أدخل كلمة مرور جديدة أدناه.', 'techno-souq-theme')); ?>
        </p>
        ...
        <form method="post" class="woocommerce-ResetPassword lost_reset_password y-c-auth-form" data-y="reset-password-form">
            <div class="y-c-form-field" data-y="password-1-field">
                <label for="password_1" class="y-c-form-label">
                    <?php esc_html_e('كلمة المرور الجديدة', 'techno-souq-theme'); ?>
            ...
            <div class="y-c-form-field" data-y="password-2-field">
                <label for="password_2" class="y-c-form-label">
                    <?php esc_html_e('إعادة إدخال كلمة المرور الجديدة', 'techno-souq-theme'); ?>
                    <span class="y-c-required-mark">*</span>
                </label>
            ...
            <button type="submit" class="woocommerce-Button button y-c-btn y-c-btn-primary y-c-btn-full" value="<?php esc_attr_e('حفظ', 'techno-souq-theme'); ?>" data-y="save-password-submit">
                <?php esc_html_e('حفظ', 'techno-souq-theme'); ?>
            </button>
        </form>
    </div>
</div>
