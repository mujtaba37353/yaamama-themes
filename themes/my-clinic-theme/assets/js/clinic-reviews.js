/**
 * Clinic Reviews JavaScript
 */
(function() {
    'use strict';
    
    document.addEventListener('DOMContentLoaded', function() {
        const reviewForm = document.getElementById('add-review-form-clinic');
        const reviewMessage = document.getElementById('review-message-clinic');
        ...
        reviewForm.addEventListener('submit', function(e) {
            ...
            formData.append('action', 'add_clinic_review');
        ...
        function initStarRatings() {
            const starInputs = document.querySelectorAll('#add-review-form-clinic .star-rating-input');
