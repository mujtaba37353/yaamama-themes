...
class CustomDropdown {
    constructor(dropdownElement) {
        ...
        this.currentText = this.dropdown.querySelector('.current-sort, .dropdown-current');
    ...
    getSelection() {
        const selected = this.dropdown.querySelector('.dropdown-options li.selected');
        if (selected) {
            const data = {};
    ...
    setSelection(selector) {
        const option = this.dropdown.querySelector(`.dropdown-options li${selector}`);
        if (option) {
