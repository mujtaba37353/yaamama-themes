jQuery(function ($) {
    ...
    if (typeof window.wc !== 'undefined' && typeof window.wp !== 'undefined' && typeof window.wc.wcSettings !== 'undefined' && typeof window.wc.wcBlocksRegistry !== 'undefined') {
        const settings = window.wc.wcSettings.getSetting('paymob-19305-card-vpc-sar_data', {});
        ...
        const Icon = () => {
            return settings.icon
                ? window.wp.element.createElement('img', {
                    src: settings.icon, id: 'paymob-19305-card-vpc-sar-logo', style: {
                        maxWidth: '70px',
                        float: 'right',
                        paddingTop: '6px'
                    }
        ...
        const Block_Gateway = {
            name: 'paymob-19305-card-vpc-sar',
        ...
        const css = `
         html[lang="en"] #paymob-19305-card-vpc-sar-logo {
             float: right !important;
         }
         html[lang="ar"] #paymob-19305-card-vpc-sar-logo {
